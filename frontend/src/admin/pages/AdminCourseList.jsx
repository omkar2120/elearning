    ...
    <div style={{height:"calc(100vh - 10%)"}}>
        ...
        <TableBody>
                {adminState.courses.map((d)=>(
                    ...
                    <StyledTableCell align="center"><Button variant='contained' color="success">Edit</Button></StyledTableCell>
                    <StyledTableCell align="center" ><Button variant='contained' color='error'>Delete</Button></StyledTableCell>
